...
//	private ElementPainterProvider painter;
...
//		painter = new ElementPainterProvider(data, this);
		setShapeFactor(1);
...
//		paintManager.addAsyncPaintListener(new OutlinePainter(this));
	}
	...
	public void initializeOffscreenViewer(INetworkDataViewer aViewer, int width, int height) {
		...
		viewer.setShapeFactor(0.75 * factor);
...
//			}
//		}
		return paintManager.getObjectFromScreen(x, y);
	}
...
//			}
//		}
//		if(draggingObject != null) { // FIXME must be moved
//			int[] coords = new int[] {
...
//	}
    ...
    protected void setShapeFactor(double factor) {
//		createStrokes((float) (1.0 * factor), (float) (2.5 * factor));
...
//    	painter.setShapeFactor(factor); // TODO test export image
    }
...
//	}
	...
	public int getBaseVoltage(Branch branch) {
	...
	public void fireDisplayTimeChanged(DisplayTimer timer) {
		paintManager.fireDisplayTimeChanged(timer);
		repaint();
	}
...
//		updateVoltageLevels();
	...
	public void elementChanged(DatabaseChangeEvent event) {
		paintManager.checkUpdateListeners(event);
	}
	...
	public CaseViewer getNetworkContainer() {
