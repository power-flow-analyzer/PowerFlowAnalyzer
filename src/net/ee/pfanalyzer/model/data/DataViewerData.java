 ...
 *         &lt;element name="dialog" type="{http://www.mehg.net/schema/PowerFlowAnalyzer}DataViewerDialogData" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
public class DataViewerData {
    ...
    protected List<DataViewerDialogData> dialog;
    @XmlAttribute
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link DataViewerDialogData }
     * 
     * 
     */
    public List<DataViewerDialogData> getDialog() {
        if (dialog == null) {
            dialog = new ArrayList<DataViewerDialogData>();
        }
        return this.dialog;
    }
