...
%     write_datasource_excel(network_data.nodes, output_file, 'Nodes', 1, 1, 2);
% end
write_datasource_excel(network_data.nodes, output_file, 'Nodes', 1, 1, 2);
write_datasource_excel(network_data.lines, output_file, 'Lines', 1, 1, 2);
write_datasource_excel(network_data.transformers, output_file, 'Transformers', 1, 1, 2);
write_datasource_excel(network_data.transformer_regulation, output_file, 'Transformer Regulation', 1, 1, 2);
end
